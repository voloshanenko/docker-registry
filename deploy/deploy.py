...
portainer_stack_name = os.environ.get('PORTAINER_STACK_NAME') or 'dockerregistry'
...
def main():
    ...
    try:
        ...
        stack_env_variables = ["VIRTUAL_HOST", "VIRTUAL_PORT", "LETSENCRYPT_HOST", "LETSENCRYPT_EMAIL"]
        stack_env_dict = []
